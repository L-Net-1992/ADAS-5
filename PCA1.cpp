...
void print2DArray(Array2D<double> a, int a1, int a2)
{
	for (int i = 0; i < a1; i++)
	{
		cout << endl;
...
int main(int argc, char* argv[]) {
	...
	const int row = 10;
	const int col = 2;
	char *path = "C:/Users/Nitin/Documents/Visual Studio 2013/filesTestData.txt";
	Array2D<double> d(row, col);
	load_data_from_file(d, path);
	...
	print2DArray(eigenvector, dim, dim);
//	cout << eigenvector << endl;

	cout << "The eigenvalues:" << endl;
//	cout << eigenvalue << endl;
	print2DArray(eigenvalue, dim, dim);
...
//	cout << final_data << endl;
	print2DArray(final_data, row, col);
